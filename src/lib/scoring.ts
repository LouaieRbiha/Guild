...
// Per-piece roasts for particularly bad or great artifacts
const PIECE_ROASTS: Record<string, string[]> = {
  terrible: [
    "This piece belongs in the strongbox. Actually, even the strongbox would reject it. Every substat rolled into something you don't need — it's like the game is trolling you personally.",
    "I've seen 4-star artifacts with better rolls than this. I've seen INVESTIGATION DROPS with better rolls than this. That's not hyperbole. I checked.",
    "Every single roll went into the worst possible substat. The odds of this are actually lower than getting a 5-star character. You hit pity on failure.",
    "This artifact is actively making your character weaker. If you unequipped it entirely, your character might actually thank you. In writing.",
    "The domain gave you this as a joke. You equipped it as a tragedy. Somewhere, a Hilichurl is wearing a better flower and it doesn't even have hands.",
    "This piece has the same energy as bringing a water gun to a boss fight. And then the water gun breaks. And then it starts raining. On you specifically.",
    "Flat DEF and flat HP said 'we got you fam' and they meant it. Got you good. Got you real good. Your DPS dropped just looking at this.",
    "If artifacts had feelings, this one would be ashamed of itself. It would change its name and move to a different account. Witness protection for artifacts.",
    "This piece rolled like a drunk character dodging — everywhere except where it needed to be. The substats are a masterclass in wasted potential.",
    "I ran the numbers on this piece: it contributed exactly nothing to your build. Negative value. Your character would deal more damage wearing a potato.",
    "This artifact has been through 5 upgrades and each one was a disappointment. Like opening 5 birthday presents and they're all socks. Flat DEF socks.",
  ],
  bad: [
    "This piece is trying its best. Its best just isn't very good. Like a puppy trying to fetch — adorable effort, zero results.",
    "One or two rolls went right. The rest went on vacation. Permanent vacation. They're not coming back.",
    "This piece has 'I'll do' energy. But barely. It's the fast food of artifacts — it fills a slot but nobody's excited about it.",
    "You kept this because you had nothing better. I understand. I don't approve, but I understand. We've all been there at 3am, desperate and out of resin.",
    "The substats on this piece are having an identity crisis. Half of them want to be a DPS piece, half want to be a support piece. The result is neither.",
    "This piece got one good roll and then immediately gave up, like your motivation to keep farming this domain. I get it. The domain gets it. We all get it.",
    "If this piece were a student, it would be the one who did the homework but forgot to write their name on it. So close, yet so meaningless.",
    "The main stat is carrying this piece on its back while the substats sit in the wagon eating chips. Freeloaders.",
  ],
  decent: [
    "Not bad! A few more rolls in the right place and this could've been great. But 'could've been' is the saddest phrase in artifact farming.",
    "This piece is the definition of 'close but no cigar.' The crit rolls are there, they're just... not all there.",
    "Decent piece. Your character isn't complaining, but they're not celebrating either. It's a Tuesday of an artifact.",
    "A solid B effort. Like homework you did at 2am but still passed. Not your finest work, but it gets the job done.",
  ],
  great: [
    "Now THIS is a piece worth keeping. The rolls actually cooperated for once. Frame it. Tell your friends. They won't care, but tell them anyway.",
    "This artifact understood the assignment. Mostly. It's the honor student of your build — making the others look bad by comparison.",
    "Every time you look at this piece, thank the RNG gods and move on before they take it back. Seriously. Don't draw attention to it.",
    "This is the piece that justifies all those painful domain runs. Every flat DEF you endured led to this moment. Chef's kiss.",
  ],
};
